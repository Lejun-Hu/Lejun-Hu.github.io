...
*本文为个人博客技术笔记系列的第二篇，其前篇为 [《GPU 卡间互联协议深度调研》](/notes/GPU_Interconnect_Research/)，聚焦于 AI 云端芯片之间的物理互联（scale-up 与 scale-out 两层）。本文则从软件栈视角出发，完成从框架到硬件的全路径拆解。两篇文章互补，共同构成对 AI 计算系统"硬件互联 + 软件栈"的完整分析框架。*

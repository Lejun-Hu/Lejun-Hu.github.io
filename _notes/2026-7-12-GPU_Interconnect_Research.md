...
这种"InfiniBand 封闭 + Spectrum 开放"的双轨策略，本质上是英伟达在 scale-out 层的左右互搏：用 InfiniBand 守住对极致性能有要求的顶级客户（如超大规模训练集群），用 Spectrum-X 去抢博通和 Marvell 在以太网交换机市场的地盘。2026 年 Q1 Spectrum-X 登顶全球数据中心交换机营收榜首，说明这条"开放路线"正在奏效。

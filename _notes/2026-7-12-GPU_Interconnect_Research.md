...
英伟达在 scale-out 层的交换机（InfiniBand Quantum 系列和以太网 Spectrum 系列）均采用自研 ASIC 芯片，这得益于 2019 年以 69 亿美元收购 Mellanox——英伟达由此获得了从芯片设计到协议栈的完整交换能力。但英伟达并非在所有领域都走封闭路线。2026 年 3 月，英伟达与 Marvell 宣布达成战略合作，英伟达向 Marvell 投资 20 亿美元，将 Marvell 的定制芯片（XPU）、高速模拟前端、光 DSP 和硅光互连产品接入 **NVLink Fusion** 生态。这意味着英伟达的策略是**双轨并行**：自己的高端产品线（Spectrum-X、Quantum）用自研 ASIC，保持最优性能和最高毛利；同时通过 NVLink Fusion 拉拢 Marvell 等第三方芯片商，用半开放姿态争夺那些不愿意被单一供应商锁定的客户——本质上是在开放生态的战场上与博通 Tomahawk/SUE 和 UALink ULS 正面竞争。

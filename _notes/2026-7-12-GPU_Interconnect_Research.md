...
根据 QYResearch 2026 年 1 月发布的最新报告，2025 年全球以太网交换芯片市场销售额达到 **374 亿元人民币**（约 52 亿美元），预计到 2032 年将增长至 606 亿元，年复合增长率约 7.3%。

| 厂商 | 2024 年市场份额 | 代表产品 | 最新性能 | 策略定位 |
|---|---|---|---|---|
| **Broadcom** | 54.6% | Tomahawk 6, Jericho 4, Trident 5 | Tomahawk 6: 102.4 Tbps, 3nm, 512×200G 端口 | 商用芯片绝对领导者，覆盖超大规模云到企业全场景 |
| **Marvell** | ~13% | Teralynx 10, T100 | T100: 102.4 Tbps, 3nm; Teralynx 10: 51.2 T, 500ns 延迟 | 低延迟+可编程，聚焦 AI 云和边缘场景 |
| **Cisco** | 9.6%（趋势下降） | Silicon One | 自研自用 | 从纯自研转向混合商用芯片策略 |
| **NVIDIA (Mellanox)** | 7–8% | Spectrum-4, Spectrum-X | Spectrum-X: 51.2 Tbps | 自研 ASIC，优先自用 + 部分外销，AI 集群专用优化 |
| **盛科通信 (国产)** | ~1.6%（国内商用市场） | Arctic 系列 | 25.6 Tbps, 800G 端口 | 国产替代领军，对标博通 Tomahawk 4 级别 |
| 其他（Microchip 等） | ~5% | — | — | 工业/企业级中小企业市场 |

需要说明的是，上述份额为**芯片层面**（即谁生产的 ASIC 被装进交换机）。在**交换机整机层面**，格局有所不同：根据 IDC 2026 年 Q1 报告，英伟达以 Spectrium-X 交换机单季营收 21 亿美元、同比暴增 192.7%，首次登顶全球数据中心以太网交换机营收榜首（21.5% 份额），超越思科和 Arista。这并非因为英伟达卖的芯片最多，而是因为 AI 集群对高性能交换机的需求急剧膨胀，Spectrum-X 的价值量远超普通企业级交换机。
...
Arista 的策略与以上三家完全不同——它**不生产交换芯片**，而是从博通采购 Tomahawk 系列芯片后，在软件层面（EOS 操作系统）做深度优化。Arista 在数据中心交换机整机市场的份额仅次于英伟达（2026 Q1），核心客户包括 Meta、Microsoft 等超大规模云厂商。在 AI 场景中，Arista 的优势在于其 EOS 对 RDMA over Converged Ethernet（RoCEv2）和 UEC 协议的成熟支持，以及多年积累的大规模网络运维自动化能力。

### 3.3 国产交换机方案

**1. 盛科通信**

盛科通信是国内唯一实现以太网交换芯片商业化的上市公司，其 Arctic 系列最高规格达到 25.6 Tbps、支持 800G 端口，产品能力对标博通 Tomahawk 4 / Marvell Teralynx 7 级别（约 2–3 年前的水平）。根据最新财报数据，盛科在国内商用以太网交换芯片市场占据 **1.6%** 的份额（2025 年），在本土厂商中排名第一。

更具战略意义的是盛科在**超节点交换芯片**细分市场的表现：2026 年，盛科在国产超节点交换芯片市场的份额达到约 **40%**，在华为昇腾超节点项目中 25.6T 芯片采购份额超过 **70%**，订单已排至 2027 年。盛科深度绑定新华三、锐捷网络等头部设备商，并在 OISA 生态中扮演交换芯片的核心供应商角色。其研发费用率高达 42%，正在押注 RISC-V CPU 集成以摆脱对 ARM 授权模式的依赖。

**2. OISA 交换芯片**

OISA 2.0 规范定义了开放的国产 scale-up 交换标准，配套的交换芯片由盛科通信等国产厂商供应。目前 OISA Switch 的交换容量为 **51.2 Tbps**，最大支持 **1,024 卡** Scale-up 互联，商用产品于 2026 年 Q2 开始出货。OISA 交换芯片的战略定位与 UALink 的 ULS 类似——打造一个独立于英伟达和博通的国产交换芯片供应链。

...
华为的智算交换机基于自研海思芯片，不依赖博通或盛科。旗舰产品 **CloudEngine 16800-X 系列**于 2023 年率先发布，支持最高 **288 个 800GE 端口**，搭载 iLossless 智能无损算法实现 0 丢包和 <10μs 超低时延。在智算交换机市场，华为以 **45–50%** 的份额稳居第一，其核心优势在于昇腾芯片 + 海思交换芯片 + CloudEngine 整机 + CANN 软件栈的全栈自研协同——这种纵向整合能力在国产厂商中独一档。
...
**4. 中兴通讯：自研"凌云"芯片，576 端口突围**

中兴通讯是国产厂商中少有的同时布局自研交换芯片和整机的玩家。2026 年 4 月发布的 800G 框式智算交换机搭载中兴微电子自主创新的**"凌云"大容量 AI 交换芯片**，整机提供 **576 个 800G 端口**，单机交换容量达到 **460 Tbps**——在单机端口密度上甚至超越了华为和新华三的同代产品。配合自研 OEX 超节点互联架构，二层组网即可覆盖超大 AI 集群，相较传统三层组网减少一层网络跳数和光模块数量。中兴在智算交换机市场的份额约 **15–20%**，位居第二，但其核心客户集中在运营商市场（中国移动、电信等），在互联网大厂中的渗透率仍低于华为和新华三。
